...
const CardSkeleton = (props: Props) => {
  return (
    <div className="flex flex-col justify-between gap-2 shadow-lg select-none w-64 max-[400px]:w-full rounded-md overflow-hidden bg-slate-100">
      ...
      <div className="p-4 flex flex-col gap-2">
        ...
        <div className="bg-gray-300 w-20 animate-pulse h-4 rounded-2xl" />
      </div>
    </div>
  );
};
