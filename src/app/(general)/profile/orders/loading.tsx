...
const Card = () => {
  return (
    <div className="max-w-screen-xl w-full rounded overflow-hidden shadow-lg my-1 bg-slate-100">
      <div className="flex flex-wrap">
        <div className="w-full sm:w-1/3 lg:w-1/5 p-3">
          ...
          <div className="bg-gray-500 w-full max-w-24 animate-pulse h-4 rounded-2xl my-2" />
          <div className="bg-gradient-to-r from-yellow-200 via-blue-200 to-green-200 w-full max-w-36 animate-pulse h-6 rounded-2xl my-2" />
        </div>
        <div className="w-full sm:w-1/3 lg:w-1/5 p-3">
          <div className="bg-gray-500 w-full max-w-24 animate-pulse h-4 rounded-2xl my-2" />
